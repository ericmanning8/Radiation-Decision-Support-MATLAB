...
[v_rectumIntersecting, r_rectumIntersecting] = hist(rectumIntersectingSub(:,4));
...
[v_rectumNonIntersecting, r_rectumNonIntersecting] = hist(rectumNonIntersectingSub(:,4));
...
v_bladder = v_bladder./(bladderVolume/100);
...
v_rectum = v_rectum./(rectumVolume/100);
cum_v_rectum = cumsum(v_rectum);
