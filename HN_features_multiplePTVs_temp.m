...
patient_ids=[1 2];
color = [65 105 225; 255 255 0; 255 165 0; 255 20 147; 255 0 0; 51 255 255; 0 128 0; 32 178 170; 102 102 102; 51 0 0; 204 102 102; 153 0 102; 51 204 51; 255 204 0; 204 255 51; 102 51 0; 201 153 153; 204 255 51; 51 102 0; 204 204 204;102 102 0; 102 0 51; 255 204 255; 255 204 153; 102 0 102]/255; 
...
for pid=1:1
    ...
    for i=1:length(stdROINames) %For each ROI in the patient's ROI Sequence
        ...
        if (strcmp(stdROINames{i},'parotidRt')||strcmp(stdROINames{i},'parotidLt')||strcmp(stdROINames{i},'mandible'));
