...
color = [65 105 225; 135 206 250; 255 255 0; 255 165 0; 255 20 147; 255 0 0; 51 255 255; 0 128 0; 32 178 170; 102 102 102; 51 0 0; 204 102 102; 153 0 102; 51 204 51; 255 204 0; 204 255 51; 102 51 0; 201 153 153; 204 255 51; 51 102 0; 204 204 204;102 102 0; 102 0 51; 255 204 255; 255 204 153; 102 0 102]/255; 
...
for i=1:length(stdROINames) %For each ROI in the patient's ROI Sequence
    ...
    if (strcmp(stdROINames{i},'parotidRt'))
        ...
        ptvs = mysql(horzcat('SELECT stdROIName FROM structure_set_roi_sequence WHERE stdROIName LIKE "ptv%" AND fk_patient_id = "',num2str(patient_id),'"'));
...
%                 mysql(horzcat('UPDATE structure_set_roi_sequence SET ',ptvName,' = "',ptvs{ptvIndex},'"'));
...
%saveas(figure(1),horzcat('/Users/ruchi/Documents/IPI/RadiationOncology/Results/hnAnalysis72/patient',num2str(patient_id),'ptv1.fig'));
...
if (length(ptvs)>1)
    ...
    ylabel('Percentage Volume of ROI');
    legend(legendList,'Location','BestOutside');
    %saveas(figure(2),horzcat('/Users/ruchi/Documents/IPI/RadiationOncology/Results/hnAnalysis72/patient',num2str(patient_id),'ptv2.fig'));
end;
...
if (length(ptvs)==3)
    ...
    ylabel('Percentage Volume of ROI');
    legend(legendList,'Location','BestOutside');
    %saveas(figure(3),horzcat('/Users/ruchi/Documents/IPI/RadiationOncology/Results/hnAnalysis72/patient',num2str(patient_id),'ptv3.fig'));
end;
